...
//To added ViewModel once Module 4 is done.
//    val expended = remember { MutableStateFlow(false) }
//    val expendedValue = expended.collectAsState()
...
fun ExoInfo(
    ...
    Column(
        ...
        Row(
            ...
            ExoButton(expended = expended, onClick = { expended = !expended })
        }
    }
}
