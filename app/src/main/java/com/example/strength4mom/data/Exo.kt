...
val exos = listOf(
    ...
    Exo(R.drawable.singlelegdeadlift, R.string.exercise_2, 4, 10, R.string.exercise_description_2),
    Exo(R.drawable.glutebridge, R.string.exercise_3, 4, 15,R.string.exercise_description_3)
)